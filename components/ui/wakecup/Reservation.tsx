...
export default function Reservation() {
	return (
		<div className="grid grid-cols-1 gap-y-10 px-6 pt-40 pb-20 text-[24px] font-bold leading-[30px] md:grid-cols-2 md:items-center md:px-10 md:pb-40 md:pt-[200px] md:text-[40px] md:leading-[48px]">
