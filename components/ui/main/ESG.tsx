	...
	return (
		<div className="flex h-[800px] flex-col items-center gap-y-12 pt-[4.5rem] md:h-[720px] md:gap-y-8 md:pt-[64px]">
			<div className="text-center">
				<div className="flex flex-col justify-center text-[32px] leading-[40px] md:text-[28px] lg:flex-row lg:gap-x-2">
					<h1 className="font-normal">텀블러와 함께</h1>
					<h1 className="font-black">하루 1번 2년이면</h1>
				</div>
				<div className="mt-8 flex flex-col justify-center text-[40px] font-bold leading-[44px] text-secondary md:mt-[8px] lg:flex-row lg:gap-x-2">
					<h1 className="font-medium">온실가스 발생량</h1>
					<h1 className="font-black">33배 감소</h1>
				</div>
			</div>
			<div className="relative flex w-full justify-center bg-bg-primary">
				...
				<div className="mt-[32px] hidden h-[404px] w-full flex-col items-center md:flex lg:h-[520px]">
					<Image
