export default function IdentityTypo() {
	return (
		<div className="rotate-[-15deg] font-chaney font-normal">
			<h3 className="animate-[textLoop_20s_linear_infinite] text-[32px] leading-[40px] opacity-70">
